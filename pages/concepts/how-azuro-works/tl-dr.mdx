...
[**Rewards**](https://gem.azuro.org/concepts/how-azuro-wors/rewards) on each **Condition** is calculated, stored on an onchain vault, then disbursed to relevant protocol actors (i.e., apps, LP, data provider, **AzuroDAO**) on a monthly basis.
