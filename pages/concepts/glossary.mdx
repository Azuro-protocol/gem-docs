...
based on supply and demand. Azuro utilises AMM mechanic inside its predictions engine to adjust odds and provide users with
correct values.
...
The margin (also referred to as "spread" or "vig/vigorish") is the difference between the probability of a prediction
outcome happening and the odds that players can make predictions with (for this outcome). In traditional
