...
accepting bets, computing payouts for bets, and calculating [Affiliate](/concepts/basic/affiliates) [rewards](/concepts/basic/fees-and-rewards).
...
process on 2-outcome Conditions. At present, the Azuro project includes two Betting Engines: [PrematchCore](/contracts/prematch-core)
