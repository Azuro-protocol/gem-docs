...
on their initial odds provided by the [Feed Provider](/concepts/basic/feed-providers). When a bettor places a bet,
...
Thus, automatic market making of the betting odds is performed. However, Feed Provider also has the ability to change
