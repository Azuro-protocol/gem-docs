...
<Formula className="text-md">
    $$
    \text{ where }
    \\R \text{ is the [Reinforcement](/concepts/protocol/reinforcement) of a Condition },
...
The main distinctive feature of Virtual Funds is that, despite their size incorporating the Reinforcement size
designated at the creation of the Condition, the Reinforcement is not locked on the [LP](/contracts/lp) balance fully.
