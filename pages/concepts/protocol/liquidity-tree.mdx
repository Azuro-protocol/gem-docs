...
<Callout type="info">
  Learn more about the Liquidity Tree Infrastructure on [this](https://medium.com/@frankcc/the-liquidity-tree-a-novel-liquidity-infrastructure-for-on-chain-prediction-markets-294e6e8a5341) Medium article.
</Callout>
...
The Liquidity Tree is a data structure used to track provided liquidity, based on a segment tree. In the task of liquidity
accounting, the root node contains the most up-to-date liquidity value.


### Liquidity Tree Organization

All Liquidity Tree nodes are stored as elements of an array. To store data in **K** elements, an array of size
...
_Example of a Liquidity Tree for storing 4 elements:_
