...
A snapshot of Azuro Score Phase 1 participants has been taken. All Phase 1 addresses part of the snapshot will receive a multiplier/boost to their points at the end of the Azuro Score program (before the token-generation event).
</Callout>

Addresses that are part of the snapshot have received respective roles in Discord: **High Rollooor** (>=100,000 points accrued in Phase 1); **Believoooor** (10,000 - 99,999 points accrued in Phase 1); **Bottoooom G** (1,000-9,999 points accrued in Phase 1).
