...
<Callout type="info">
  - Example: a user with Azuro Score less than 100,000 makes a bet of $10 at odds of 3 (European odds used for the example). Points are calculated like this: **10 * 3 * 5 = 150 points**
...
<Callout type="info">
  As of Nov 10, 2023, liquidity added to the Polygon USDT pool earns 3x the Azuro Score points (i.e. 3 * 1.05=3.15).
</Callout>
