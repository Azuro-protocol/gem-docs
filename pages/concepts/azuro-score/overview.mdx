...
---
<Callout type="info">
  As of Nov 10, 2023, liquidity added to the Polygon USDT pool earns 3x the Azuro Score points (i.e. 3 * 1.05=3.15) ! This boost will remain in place at least until the Polygon pool hits 10M USDT in size!
</Callout>
