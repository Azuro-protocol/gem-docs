...
When a user provides liquidity - his tokens will start to earn with the Pool from the next betting event which will be
...
<Callout type="warning">
  Currently there is a lockup period of **7 days** after liquidity is deposited. This means you can provide liquidity for
