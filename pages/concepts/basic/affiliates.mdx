...
In the simplest example (i.e. a prediction app like [bookmaker.XYZ](https://bookmaker.xyz)) - by integrating Azuro - the frontend gains opportunity to access to liquidity pools created on the basis of Azuro solution, outsources risk management, and may simply focuses on interactions with Users and development of UX.
