...
In the simplest example (i.e. a prediction app like [bookmaker.XYZ](https://bookmaker.xyz)) - by integrating Azuro - the frontend "outsources" liquidity and risk management, while it focuses purely on UX & marketing.
