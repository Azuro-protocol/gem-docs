...
$$
\begin{aligned}
\text{Affiliate Reward} &= \text{70\% of Affiliate Revenue} \\
&\text{(but not higher than the Spread Reward Cap)}
\end{aligned}
$$
</Formula>

- **Affiliate Revenue** = Monthly Pool Revenue (bets placed minus winnings) via the Affiliate address
- **Spread Reward Cap** = (50% of Spread)*(Bet Size) for all bets associated with the affiliate address, resolved in the calendar month
- **Spread** = The spread (aka vig, aka margin) for each particular bet
- **Bet size** = The amount (in respective cryptocurrency) of each particular bet
