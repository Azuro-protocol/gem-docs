...
A fairer distribution of losses among depositors, for cases where players win more. Changes have been made to the liquidity tree smart contract code, so a liquidity migration to the new smart contract will be necessary.

### Migration
Added methods for migrating liquidity from the V2 protocol to the new V3 liquidity contract. Thus, deposit holders will be able to migrate liquidity on their own.
