...
[Contracts](/contracts/live-host-core) / [Subgraph](/subgraph/overview#live-endpoints) / [Guides](/guides/advanced/live/overview)
...
We have added a new API for bets registering and processing. This API allows to place an [`order`](/knowledge-hub/additional/glossary#order) (signed bet request) and track its status.
