...
<Image
  src="/images/cases/cotnract-chains.png"
  width={2000}
  height={1000}
/>
...
A Prediction Engine (aka Betting Engine) is a collective term for contracts that encompass the logic of creating [Conditions](https://gem.azuro.org/concepts/protocol/conditions), accepting bets, computing payouts for bets, and calculating [Affiliate](https://gem.azuro.org/concepts/basic/affiliates) [rewards](https://gem.azuro.org/concepts/basic/rewards).

These contracts are plugged into the [Pool](https://gem.azuro.org/concepts/protocol/pools) by its owner via the [Factory](https://gem.azuro.org/contracts/factory), and access to place bets and withdraw payouts is only granted through the [LP](https://gem.azuro.org/contracts/lp) contract for which it was deployed.
