...
We are planning **Azuro Protocol V3** release around **May 1st**, and **V2 will no longer be supported**. A warning will be issued one week before the release. Throughout April, we will update Azuro Protocol based on feedback without making structural changes. Stay tuned for further updates. [Read more](hub/protocol-v3/overview)
</Callout>
