...
Now we have components to create a modal to place a bet. Here we'll need your **affiliate address**, which we described [here](/hub/apps/guides/affiliate-wallet).
