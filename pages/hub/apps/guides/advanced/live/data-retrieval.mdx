...
We recommend you to call a snapshot of live games almost the same way you did it for prematch games (see [Get Games](/guides/advanced/prematch/get-games) section),
...
For each live game you can request its markets (called `conditions`) the same way you do this for prematch games (see [Prepare game markets](/guides/advanced/prematch/markets-and-outcomes) section).
