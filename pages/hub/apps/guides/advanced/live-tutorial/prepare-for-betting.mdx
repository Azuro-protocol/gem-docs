...
- It leverages the `useStatuses` hook ([source code](https://github.com/Azuro-protocol/sdk/blob/v3.1.0/src/hooks/useOdds.ts), [docs](/hub/apps/sdk/watch-hooks/useStatuses))
