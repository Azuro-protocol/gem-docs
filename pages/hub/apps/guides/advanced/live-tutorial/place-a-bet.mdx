...
# Adding Live. Step 4: Place a bet
...
```ts {16-36, 59-64, 73, 89, 98, 119-121, 134-246, 322-323, 348-349} copy filename="usePrepareBet.ts"
...
<Callout type="info">
To obtain the `minOdds`, utilize the [`calcLiveOdds`](/hub/apps/guides/sdk/utils/calcLiveOdds) function from our SDK in conjunction with the odds data retrieved from the [Socket API](/hub/apps/guides/advanced/live/data-retrieval#get-realtime-markets-updates).
