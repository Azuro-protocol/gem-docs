...
Use the [Azuro Cashout API](https://api.azuro.org/api/v1/public/cashout/get-available) to get available.
...
### Get calculation
Calculates the exact cashout amount based on the bet in the contract. Use the [Azuro Cashout API](https://api.azuro.org/api/v1/public/cashout/get-calculation) to get calculation.
