...
<Callout type="advice">
  ...
  **Account for this in your UI.** The [Guidelines PDF](/files/Azuro_Waves_UI_Guidelines.pdf) includes a recommendation for the User Widget UI in this case.
</Callout>

## UI Guidelines

Please follow the [Azuro Waves Guidelines](/files/Azuro_Waves_UI_Guidelines.pdf) in your UI.
...
<div className="mt-3 sm:max-w-96">
  <Card
    ...
    text="PDF"
    toTab="/files/Azuro_Waves_UI_Guidelines.pdf"
  />
</div>
