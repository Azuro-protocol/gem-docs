...
```ts
{
  ...
  livePollInterval?: number // live conditions can be created at any time, and here, you can specify how frequently to check for new live conditions **measured in milliseconds**
  filter?: {
    outcomeIds?: string[]
  }
}
