...
The PrematchCore is a [Betting Engine](/concepts/protocol/betting-engines) contract implements all the necessary logic
for conducting pre-match betting with multiple outcomes. [Data providers](/concepts/basic/data-providers) can create
