...
Use the [Azuro FreeBets API](https://api.azuro.org/api/v1/public/freebets/docs/static/index.html) to get info about
...
const baseUrl = isDev
  ? 'https://dev-api.azuro.org/api'
  : 'https://api.azuro.org/api'
