...
accepting bets, computing payouts for bets, and calculating [Rewards](/concepts/basic/fees-and-rewards). These contracts can
...
- [FreeBet](/concepts/protocol/freebets). A tool that enables granting free bets to any user.
