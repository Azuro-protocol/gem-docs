...
Apps' reward is paid monthly, separately for each chain. Each app's final take-home reward will be the lower of its *RevenueReward* and the sum of its *SpreadRewardCap* for that month.
