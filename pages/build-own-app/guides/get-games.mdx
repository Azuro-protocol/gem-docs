...
<Callout type="warning" emoji="⚠️">
  We highly recommend reading the ["GraphQL" section](/build-own-app/dive-deeper/graphql) first.
</Callout>
...
contract to use based on your specific use case and business requirements. [Get more information](/build-own-app/dive-deeper/contracts#avoid-duplications).
...
<Callout type="warning" emoji="⚠️">
  From ["GraphQL" section](/dive-deeper/graphql#specificity):
