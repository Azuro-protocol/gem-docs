...
of source files [here](https://github.com/Azuro-protocol/dictionaries/blob/main/dictionaries/src).
...
import dictionaries from '@/dictionaries' // the path to the downloaded files
