...
{
  prematchClient: ApolloClient<NormalizedCacheObject> | null // used for get pre-match data
  liveClient: ApolloClient<NormalizedCacheObject> | null // used for get live data
}
```
