...
3. The user places a bet using the provided freebet*. _(How-to in [Place a bet](/guides/advanced/prematch/place-a-bet#place-a-freebet) section)_
4. After the event is resolved:
* If the bet wins, when the user claims their winnings (_how-to in [Redeem bets](/guides/advanced/prematch/redeem-bets#freebet-redeem) section_), they receive a profit from the win (payout - freebet amount),
...
3. [Distribute freebets with admin panel](/guides/freebets/distribute-freebets#distribute-freebets-with-azuro-admin-panel).
