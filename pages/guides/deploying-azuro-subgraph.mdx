...
- [graph-cli](https://thegraph.com/docs/developer/cli)
...
### 3. Configure Your Subgraph

Edit the configuration file `config/<NETWORK>.js` to support your smart contracts. This file contains pre-configured addresses and start blocks of Azuro Protocol contracts.

### 4. Generate Subgraph Configuration
