...
<Image
  src="/images/live/place-a-bet.png"
  width={2010}
  height={1846}
/>
...
```ts
// Example code is provided for `ethers v6` library
...
Then the user must sign this message with his EVM wallet:
...
const API_BASE_URL = 'https://...'; // Azuro Live Betting API base url
...
When you've got a bet id, you can work with it like with prematch bets.
