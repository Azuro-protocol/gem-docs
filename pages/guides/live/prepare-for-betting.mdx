...
Before a user can start betting, he needs to claim some amount of this token by calling `claim` write method. Each user can receive 1000 AZUSD once every 24 hours.
We recommend you as a frontend operator to create a convenient interface to do that in 1 click and claim `1000 AZUSD` to the user's wallet.
