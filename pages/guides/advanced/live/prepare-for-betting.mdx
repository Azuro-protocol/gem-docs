...
After you [retrieved games and markets](/guides/advanced/live/data-retrieval), you can start to create a betting flow.
...
Now you can proceed with a [betting flow](/guides/advanced/live/place-a-bet) implementation.
