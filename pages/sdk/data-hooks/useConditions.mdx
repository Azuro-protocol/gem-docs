...
The Hook should be used if [`useGameMarkets`](/sdk/data-hooks/useGameMarkets) doesn't suit your needs. [Here](https://github.com/Azuro-protocol/sdk/blob/main/src/hooks/useGameMarkets.ts#L170) is an example demonstrating usage, employing the `useGameMarkets` hook.
</Callout>
