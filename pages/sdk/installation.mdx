...
2. The second is for those who don't need an example project and can make a dApp from ground up that interact with Azuro protocol as easily as our pre-built example.
...
## 2. To use SDK in your original progect
