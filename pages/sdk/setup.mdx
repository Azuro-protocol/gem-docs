...
```ts
import { useConditionStatusWatcher, useOddsWatcher } from '@azuro-org/sdk'
...
After completing the watchers setup, you can begin using the [Watch Hooks](/sdk/watch-hooks/useConditionStatus).
