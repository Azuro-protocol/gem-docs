...
protocol dictionaries. "dictionaries" is set of files with text descriptions of specific outcome. Check [v2.0.1 dictionaries](https://github.com/Azuro-protocol/public-config/tree/main/dictionaries/v2.0.1/json/maps)
