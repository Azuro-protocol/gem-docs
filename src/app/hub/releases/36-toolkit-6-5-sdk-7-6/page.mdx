...
# Toolkit v6.5 & SDK v7.6 — August 17, 2026
...
surviving legs and refunds the rest, but **the indexer keeps the full pre-void payout until the bet is
redeemed**, and only replaces it with the real on-chain amount when the bettor claims. Until then the
recorded figure still credits the voided leg's odds as if that leg had won, so it overstates what the
bettor can claim.
