...
Use the `startsAt` field in your query to filter and display only ongoing or future games.
For example, you could modify the query to only retrieve games that are scheduled to start in the future:
