...
2. **[Backend API](/hub/apps/APIs/backend)** - For feed data, bet calculation, order management, and cashout processing

3. **[Graph API](/hub/apps/APIs/graph)** - For querying historical data and bet information

4. **[WebSocket API](/hub/apps/APIs/websocket)** - For real-time updates on games and conditions
