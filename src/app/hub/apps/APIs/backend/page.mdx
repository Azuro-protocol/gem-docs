...
- **Data Feed**: Gets real-time data from the Azuro Protocol's feed (sports, games, conditions, odds)\
"Market Manager" in [API Documentation](https://api.onchainfeed.org/api/v1/public/gateway/docs#/Marker%20Manager)
...
- **Freebet Management**: Manages freebets and their distribution. [See guide](/hub/apps/guides/freebets)
- **Cashout Processing**: Handles early cashout requests for active bets. [See guide](/hub/apps/guides/cashout)
