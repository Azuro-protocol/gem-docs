...
<Callout type="warning">
  ...
  It opens and maintains the statistics socket itself — there is no separate watcher to mount:

  ```tsx
    import { ChainProvider, LiveStatisticsSocketProvider } from '@azuro-org/sdk'
