...
- Start of Wave 5 → 00:00:00 UTC March 6th, 2025
- End of Wave 5 → 23:59:59 UTC May 5th, 2025
- **Total airdrop reward → 350,000 AZUR**
...
| Activity | Formula |
| --- | --- |
| [Placing Bets](https://azuro.org/ecosystem) | **Polygon/Gnosis:** <br/> Х points =  \{Bet sum\} * min( \{Odds\}; 10) / 5<br />e.g. 1 point = \$2.5 bet at odds of 2 (European odds format) <br/><br/> **Base chain:** <br/> Х points = **2500** * \{Bet sum\} * min( \{Odds\}; 10) / 5<br/>e.g. 1 point = 0.001 WETH bet at odds of 2 (European odds format) <br/><br/> **Chiliz chain:** <br/> Х points = **0.05** * \{Bet sum\} * min( \{Odds\}; 10) / 5<br/>e.g. 1 point = 50 CHZ bet at odds of 2 (European odds format) |
