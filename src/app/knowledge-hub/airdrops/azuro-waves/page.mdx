...
The Azuro Waves program is the successor to [Azuro Score](/knowledge-hub/airdrops/azuro-score).
</Callout>
...
**We’re temporarily pausing the program as we gear up for an exciting reboot of Azuro Waves in V3. Get ready for enhanced mechanics, bigger rewards, and an even smoother experience — coming very soon!**
