import { Callout, Button, Formula } from 'components'
...
<Callout type="feature">
  ...
  Data endpoints will remain accessible until July 1st. The Azuro Score program is being replaced by the new [Azuro Waves program](/knowledge-hub/airdrops/azuro-waves)
</Callout>
