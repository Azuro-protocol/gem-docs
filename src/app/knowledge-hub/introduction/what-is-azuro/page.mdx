...
Utilizing [vAMMs](/knowledge-hub/how-azuro-works/components/vAMM) and our novel [LiquidityTree](/knowledge-hub/how-azuro-works/liquidity-tree) fund accounting system, all prediction markets on Azuro inherit the full might of Azuro's singleton LPs. This allows each market to 'book' liquidity and scale (aka service bets) in an unconstrained manner, up to the *entire* capacity of the pool.
...
<Image
  src="/images/concepts/what-is-azuro.png"
  width={2000}
  height={700}
/>
