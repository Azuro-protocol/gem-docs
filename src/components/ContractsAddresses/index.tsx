              ...
              >
                {
                  Boolean(address) ? (
                    <code
                      className="border-black border-opacity-[0.04] bg-opacity-[0.03] bg-black wrap-break-word rounded-md border py-0.5 px-[.25em] text-[.9em] dark:border-white/10 dark:bg-white/10"
                      dir="ltr"
                    >
                      {address}
                    </code>
